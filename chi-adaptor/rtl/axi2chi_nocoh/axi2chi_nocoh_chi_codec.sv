...
module axi2chi_nocoh_chi_codec #(
  ...
  parameter int unsigned DataIdWidth = 2,
  ...
  output logic [DataIdWidth-1:0] rxdat_dataid_o,
  ...
  input logic [DataIdWidth-1:0] txdat_dataid_i,
  ...
  localparam int unsigned kRxdatDataIdLsb = 24;
  localparam int unsigned kRxdatRespLsb = kRxdatDataIdLsb + DataIdWidth;
  localparam int unsigned kTxdatDataIdLsb = 36;
  ...
  always_comb begin
    ...
    rxdat_dataid_o = rxdat_flit_i[kRxdatDataIdLsb +: DataIdWidth];
    rxdat_resp_err_o = rxdat_flit_i[kRxdatRespLsb +: 2];
    ...
    txdat_flit_o[kTxdatDataIdLsb +: DataIdWidth] = txdat_dataid_i;
