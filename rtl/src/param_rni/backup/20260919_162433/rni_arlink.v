...
module rni_arlink
    `RNI_PARAM
        (
            ...
            ,arlink_size_s2_o
            ,arlink_lock_s2_o
            ,arlink_profile_coherent_o
            ,arlink_policy_epoch_o
            ,arlink_pending_o
        );
    ...
    output wire                                 arlink_profile_coherent_o;
    output wire [7:0]                           arlink_policy_epoch_o;
    output wire                                 arlink_pending_o;
    ...
    assign arlink_profile_coherent_o = profile_fifo_out_s1_w[8];
    assign arlink_policy_epoch_o = profile_fifo_out_s1_w[7:0];
    assign arlink_pending_o = ~arlink_fifo_empty_s1_w;
