...
module rni_wr_buffer `RNI_PARAM
    ...
    input  wire [`CHIE_DAT_FLIT_DBID_WIDTH-1:0]                     txdat_original_txnid_d2_i;
    ...
    reg  [`CHIE_DAT_FLIT_DBID_WIDTH-1:0]                            txdat_original_txnid_d3_q;
    ...
    always @(posedge clk_i or posedge rst_i) begin
        if(rst_i == 1'b1)begin
            ...
            txdat_original_txnid_d3_q <= txdat_original_txnid_d2_i;
    ...
    always@* begin
        ...
        wb_txdatflit_d3_o[`CHIE_DAT_FLIT_DBID_RANGE]      = txdat_original_txnid_d3_q;
